...
NEWS_BODY = (
    ...
    "\n"
    "Первым делом — познакомиться с платформой. В Базе знаний уже лежит «Манифест» "
    "— прочитай его не для галочки, дай себе время, пропитайся. Загляни и в "
    "Поддержку — там FAQ про основные возможности платформы.\n"
    "\n"
    "В разделе Задачи тебя ждут два приветственных задания: назвать себя и снять "
    "привычный образ — и заявить, зачем ты здесь.\n"
    "\n"
