...
class Settings(BaseSettings):
    ...
    # Голосовые сообщения короткие — держим их отдельным низким потолком, чтобы
    # аудио не проходило под видео-лимит (случайная/злонамеренная заливка гигантов).
    media_max_audio_bytes: int = 26_214_400  # 25 МБ (~20 мин opus)
