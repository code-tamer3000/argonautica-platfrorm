...
/** Все тарифы, включая отключённые в боте, отсортированы по цене (любой активный
 * пользователь, id+name без цены/описания) — группировка «Все дневники» по
 * тарифу владельца. Не фильтрует по is_active: участник, купивший тариф до его
 * деактивации, не должен терять подпись своей группы. */
