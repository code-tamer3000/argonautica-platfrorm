 ...
 *
 * Для admin сервер не гейтит эти списки по потоку вообще (полный доступ) — сужаем
 * тем же общим контекстом «текущий поток» (ARG-104), что и KbList/TasksList, иначе
 * в пикере видны материалы и задачи всех прошлых потоков. Материалы дополнительно
 * группируем по категориям КБ (как в KbList).
 */
