    ...
    <div className={styles.page}>
      ...
      {intakes.length === 0 && (
        <p style={{ color: 'var(--text-secondary)' }}>
          Экспедиций пока нет — создайте первую в разделе «Экспедиции», чтобы заводить участников.
        </p>
      )}
            ...
            {editRole !== 'admin' && (
              <div className={styles.formRow}>
                ...
                <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: 'var(--text-ui)' }}>
                  ...
                  контакты и dm вне нового круга (при возврате тарифа dm вернутся
                  сами); уже сданные задачи остаются в истории. Из групповых
                  тариф-чатов участника придётся убрать вручную.
                </p>
              </div>
            )}
