...
## Стадия 21 — Раздел «Поддержка» + метрики сервера (2026-07-03…04) ✅

Обращения участников, FAQ и админ-мониторинг сервера.
...
- **Метрики сервера** — [services/system_metrics.py](../backend/app/services/system_metrics.py)
  (чтение из `/proc`, дельта-скорости через prev-снимок в Redis),
  [schemas/metrics.py](../backend/app/schemas/metrics.py), `GET /api/admin/metrics`.
- **Frontend** — [features/support/SupportScreen.tsx](../frontend/src/features/support/SupportScreen.tsx)
  ...
  [AdminMetrics](../frontend/src/features/admin/AdminMetrics.tsx).
